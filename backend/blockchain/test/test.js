...
contract('Procurement Marketplace', function(accounts) {
    ...
    it('Supplier Assign Courier', async () => {
        // let couriers = await marketInstance.couriers.call();
        // console.log(couriers);
        let result = await dellSupplierInstance.assignCourier(dhl, 1, {from: dellEmployee});  
    });
...
// contract('Procurement Marketplace (Negative Example)', function(accounts) {
//     let marketERC20Instance;
//     let marketInstance;
